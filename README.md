...
| ---------------- | ------- | -----------: | ------------------------------------------------ |
| `debounceMs`     | number  |        12000 | Задержка перед сигналом при переходе сумма>0 → 0 |
| `sound`          | boolean |        false | Короткий звук уведомления                        |
| `showBadgeCount` | boolean |         true | Бейдж на иконке по вкладке                       |

Мини‑UI настроек можно добавить в `popup.html`.
