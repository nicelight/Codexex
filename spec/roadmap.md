...
- [x] **Уведомления, i18n и логирование**
  ...
  - [x] Перевести ожидание завершения антидребезга на событие `aggregator.onIdleSettled`, чтобы уведомления и звук реагировали синхронно.
...
- [x] **Алгоритмы будильников и устойчивость**
  ...
  - [x] Применять `autoDiscardableOff` для вкладок Codex с учётом пользовательской настройки и восстанавливать значение при её отключении, документировать side-effects и проверять сценарии
    alarm → message → state.
